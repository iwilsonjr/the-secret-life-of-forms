...
$("#voteButton, #voteButton2").click(function(){
...
$("#sendFriend").validate({  
    ...
    //GA event tracking 
   _gaq.push(['_trackEvent','Share','Share',this.href]);
   
   $("#sendFriend").ajaxSubmit( { url:'/ajax/post/postFriendEmail.cfm', type: 'post', resetForm: true, success: thanksSubmit});           
  return false;
    },  
    rules: {       
    yourEmail: {
...
function triggerThankYou() { 
	...
	$(".competitor").removeClass("pickedFood");
	 _gaq.push(['_trackEvent','Vote','Vote',this.href]);
...
function thanksClose(){ 
	window.location.href = 'brackets.cfm'; /* brackets.cfm */	
}
